        ...
        <div>
            ...
            <div className='container d-flex justify-content-center'>
                <Box width={500}  display="flex" flexDirection="column">
                    <Slider style={{ marginTop: 38 }}value={year} max={2022} min={2003} valueLabelDisplay="on" onChange={(_, value) => setYear(value as number)} onChangeCommitted={(_, value) => setYearCommitted(value as number)} marks={marks} track={false} />
                </Box>
            </div>
        </div>
    )
